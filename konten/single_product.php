...
<div class="single-product">
	<div id="content" class="site-content" tabindex="-1">
		...
		<div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(0px, 0px, 0px); transition: all 0s ease 0s; width: 2052px;"><div class="owl-item active" style="width: 342px;"><a href="<?php echo base_url."assets/"; ?>assets/images/single-product/s1-1.jpg" class="zoom" title="" data-rel="prettyPhoto[product-gallery]">
				<img src="<?php echo base_url."assets/"; ?>assets/images/single-product/s1-1.jpg" class="wp-post-image" alt="">
			</a></div><div class="owl-item" style="width: 342px;"><a href="<?php echo base_url."assets/"; ?>assets/images/single-product/s1.jpg" class="zoom" title="" data-rel="prettyPhoto[product-gallery]">
				<img src="<?php echo base_url."assets/"; ?>assets/images/single-product/s1.jpg" class="wp-post-image" alt="">
			</a></div><div class="owl-item" style="width: 342px;"><a href="<?php echo base_url."assets/"; ?>assets/images/single-product/s2.jpg" class="zoom" title="" data-rel="prettyPhoto[product-gallery]">
				<img src="<?php echo base_url."assets/"; ?>assets/images/single-product/s2.jpg" class="wp-post-image" alt="">
			</a></div><div class="owl-item" style="width: 342px;"><a href="<?php echo base_url."assets/"; ?>assets/images/single-product/s3.jpg" class="zoom" title="" data-rel="prettyPhoto[product-gallery]">
				<img src="<?php echo base_url."assets/"; ?>assets/images/single-product/s3.jpg" class="wp-post-image" alt="">
			</a></div><div class="owl-item" style="width: 342px;"><a href="<?php echo base_url."assets/"; ?>assets/images/single-product/s4.jpg" class="zoom" title="" data-rel="prettyPhoto[product-gallery]">
				<img src="<?php echo base_url."assets/"; ?>assets/images/blank.gif" data-echo="<?php echo base_url."assets/"; ?>assets/images/single-product/s4.jpg" class="wp-post-image" alt="">
			</a></div><div class="owl-item" style="width: 342px;"><a href="<?php echo base_url."assets/"; ?>assets/images/single-product/s5.jpg" class="zoom" title="" data-rel="prettyPhoto[product-gallery]">
				<img src="<?php echo base_url."assets/"; ?>assets/images/blank.gif" data-echo="<?php echo base_url."assets/"; ?>assets/images/single-product/s5.jpg" class="wp-post-image" alt="">
			</a></div></div></div><div class="owl-nav disabled"><div class="owl-prev">prev</div><div class="owl-next">next</div></div><div class="owl-dots disabled"></div></div><!-- .thumbnails-single -->
		...
		<div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(0px, 0px, 0px); transition: all 0s ease 0s; width: 420px;"><div class="owl-item active synced" style="width: 62px; margin-right: 8px;"><a href="<?php echo base_url."assets/"; ?>assets/images/single-product/single-thumb1.jpg" class="first" title="">
				<img src="<?php echo base_url."assets/"; ?>assets/images/single-product/single-thumb1.jpg" class="wp-post-image" alt="">
			</a></div><div class="owl-item active" style="width: 62px; margin-right: 8px;"><a href="<?php echo base_url."assets/"; ?>assets/images/single-product/single-thumb2.jpg" class="" title="">
				<img src="<?php echo base_url."assets/"; ?>assets/images/single-product/single-thumb2.jpg" class="wp-post-image" alt="">
			</a></div><div class="owl-item active" style="width: 62px; margin-right: 8px;"><a href="<?php echo base_url."assets/"; ?>assets/images/single-product/single-thumb3.jpg" class="" title="">
				<img src="<?php echo base_url."assets/"; ?>assets/images/single-product/single-thumb3.jpg" class="wp-post-image" alt="">
			</a></div><div class="owl-item active" style="width: 62px; margin-right: 8px;"><a href="<?php echo base_url."assets/"; ?>assets/images/single-product/single-thumb4.jpg" class="" title="">
				<img src="<?php echo base_url."assets/"; ?>assets/images/single-product/single-thumb4.jpg" class="wp-post-image" alt="">
			</a></div><div class="owl-item active" style="width: 62px; margin-right: 8px;"><a href="<?php echo base_url."assets/"; ?>assets/images/single-product/single-thumb5.jpg" class="last" title="">
				<img src="<?php echo base_url."assets/"; ?>assets/images/single-product/single-thumb5.jpg" class="wp-post-image" alt="">
			</a></div><div class="owl-item" style="width: 62px; margin-right: 8px;"><a href="<?php echo base_url."assets/"; ?>assets/images/single-product/single-thumb6.jpg" class="first" title="">
				<img src="<?php echo base_url."assets/"; ?>assets/images/single-product/single-thumb6.jpg" class="wp-post-image" alt="">
			</a></div></div></div><div class="owl-nav disabled"><div class="owl-prev">prev</div><div class="owl-next">next</div></div><div class="owl-dots"><div class="owl-dot active"><span></span></div><div class="owl-dot"><span></span></div></div></div><!-- .thumbnails-all -->
		...
		<div class="brand">
			<a href="product-category.html">
				<img src="<?php echo base_url."assets/"; ?>assets/images/single-product/brand.png" alt="Gionee">
			</a>
		</div><!-- .brand -->
	...
	<div class="accessories">
		...
		<table class="layout">
			<tbody>
				<tr>
					...
					<td>
						<img class="alignright" data-echo="<?php echo base_url."assets/"; ?>assets/images/single-product/ForDescription.jpg" src="<?php echo base_url."assets/"; ?>assets/images/blank.gif" alt="">
		...
		<table class="layout">
			<tbody>
				<tr>
					<td>
						<img class="alignnone" data-echo="<?php echo base_url."assets/"; ?>assets/images/single-product/ForDescription-1.png" src="<?php echo base_url."assets/"; ?>assets/images/blank.gif" alt="">
					</td>
	...
	<table class="table">
			...
			<ol class="commentlist">
				<li itemprop="review" class="comment even thread-even depth-1">
					...
					<div id="comment-390" class="comment_container">
						...
						<img alt="" src="<?php echo base_url."assets/"; ?>assets/images/blog/avatar.jpg" class="avatar" height="60" width="60">
						<div class="comment-text">
							...
							<p class="meta">
								<strong itemprop="author">John Doe</strong> – <time itemprop="datePublished" datetime="2016-03-03T14:13:48+00:00">March 3, 2016</time>
							</p>
			...
			<li class="product_cat">
				...
				<ul class="show-all-cat">
					<li class="product_cat">
						<span class="show-all-cat-dropdown">
							Show All Categories
						<span class="child-indicator"><i class="fa fa-angle-right"></i></span></span>
						<ul style="display: none">

							<li class="cat-item cat-item-228">
								<a href="product-category.html"><span class="no-child"></span>GPS &amp; Navi</a>
								 <span class="count">(0)</span>
							</li>

							<li class="cat-item cat-item-194">
								<a href="product-category.html"><span class="no-child"></span>Home Entertainment</a>
								<span class="count">(1)</span>
							</li>

							<li class="cat-item cat-item-136">
								<a href="product-category.html"><span class="no-child"></span>Laptops &amp; Computers</a> <span class="count">(13)</span>
							</li>

							<li class="cat-item cat-item-166">
								<a href="product-category.html"><span class="no-child"></span>Cameras &amp; Photography</a> <span class="count">(5)</span>
							</li>

							<li class="cat-item cat-item-167">
								<a href="product-category.html"><span class="no-child"></span>Smart Phones &amp; Tablets</a> <span class="count">(20)</span>
							</li>

							<li class="cat-item cat-item-168">
								<a href="product-category.html"><span class="no-child"></span>Video Games &amp; Consoles</a> <span class="count">(3)</span>
							</li>

							<li class="cat-item cat-item-169">
								<a href="product-category.html"><span class="no-child"></span>TV &amp; Audio</a>
								<span class="count">(1)</span>
							</li>

							<li class="cat-item cat-item-170">
								<a href="product-category.html"><span class="no-child"></span>Gadgets</a>
								<span class="count">(3)</span>
							</li>

							<li class="cat-item cat-item-171">
								<a href="product-category.html"><span class="no-child"></span>Car Electronic &amp; GPS</a> <span class="count">(0)</span>
							</li>

							<li class="cat-item cat-item-172">
								<a href="product-category.html"><span class="no-child"></span>Accessories</a>
								<span class="count">(11)</span>
							</li>

							<li class="cat-item cat-item-173">
								<a href="product-category.html"><span class="no-child"></span>Printers &amp; Ink</a>
								<span class="count">(1)</span>
							</li>

							<li class="cat-item cat-item-174">
								<a href="product-category.html"><span class="no-child"></span>Software</a> <span class="count">(0)</span>
							</li>

							<li class="cat-item cat-item-175">
								<a href="product-category.html"><span class="no-child"></span>Office Supplies</a>
								<span class="count">(0)</span>
							</li>

							<li class="cat-item cat-item-176">

								<a href="product-category.html"><span class="no-child"></span>Computer Components</a> <span class="count">(1)</span>
							</li>
						</ul>
					</li>
				</ul>
				...
				<ul>
					<li class="cat-item cat-item-172 current-cat-parent current-cat-ancestor">
						...
						<a href="product-category.html"><span class="child-indicator open"><i class="fa fa-angle-up"></i></span>Accessories</a>
						<span class="count">(11)</span>
						<ul class="children" style="display: block;">
							<li class="cat-item cat-item-178 current-cat">

								<a href="product-category.html"><span class="no-child"></span>Headphones</a> <span class="count">(3)</span>
							</li>

							<li class="cat-item cat-item-184">

								<a href="product-category.html"><span class="no-child"></span>Power Banks</a> <span class="count">(2)</span>
							</li>
							<li class="cat-item cat-item-186">

								<a href="product-category.html"><span class="no-child"></span>Chargers</a>
								<span class="count">(1)</span>
							</li>
							<li class="cat-item cat-item-187">

								<a href="product-category.html"><span class="no-child"></span>Cases</a>
								<span class="count">(1)</span>
							</li>
							<li class="cat-item cat-item-188">

								<a href="product-category.html"><span class="no-child"></span>Headphone Accessories</a> <span class="count">(1)</span>
							</li>
							<li class="cat-item cat-item-189">

								<a href="product-category.html"><span class="no-child"></span>Headphone Cases</a> <span class="count">(1)</span>
							</li>
							<li class="cat-item cat-item-226">

								<a href="product-category.html"><span class="no-child"></span>Pendrives</a> <span class="count">(2)</span>
							</li>
						</ul>
					</li>
				</ul>
		...
		<div class="textwidget">
			<img src="<?php echo base_url."assets/"; ?>assets/images/single-product/ad-banner.jpg" alt="Banner">
		</div><!-- .textwidget -->
	</aside><!-- .widget -->
		...
		<ul class="product_list_widget">
			<li>
				<a href="single-product.html" title="Notebook Black Spire V Nitro  VN7-591G">
					<img class="wp-post-image" src="<?php echo base_url."assets/"; ?>assets/images/products/2.jpg" alt="">
			...
			<li>
				<a href="single-product.html" title="Tablet Thin EliteBook  Revolve 810 G6">
					<img class="wp-post-image" src="<?php echo base_url."assets/"; ?>assets/images/products/5.jpg" alt="">
			...
			<li>
				<a href="single-product.html" title="Notebook Widescreen Z51-70  40K6013UPB">
					<img class="wp-post-image" src="<?php echo base_url."assets/"; ?>assets/images/products/6.jpg" alt="">
			...
			<li>
				<a href="single-product.html" title="Notebook Purple G952VX-T7008T">
					<img class="wp-post-image" src="<?php echo base_url."assets/"; ?>assets/images/products/1.jpg" alt="">
			...
			<li>
				<a href="single-product.html" title="Laptop Yoga 21 80JH0035GE  W8.1 (Copy)">
					<img class="wp-post-image" src="<?php echo base_url."assets/"; ?>assets/images/products/4.jpg" alt="">
