<section class="section-product-cards-carousel animate-in-view fadeIn animated" data-animation="fadeIn">
	...
	<div id="homev3-products-cards-carousel">
		...
		<div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(0px, 0px, 0px); transition: all 0.25s ease 0s; width: 2340px;"><div class="owl-item active last-active" style="width: 1170px;"><ul class="products columns-2">
    ...
    <div class="product-outer" style="height: 216px;">
		<div class="media product-inner">
			...
			<a class="media-left" href="single-product.html" title="Pendrive USB 3.0 Flash 64 GB">
				<img class="media-object wp-post-image img-responsive" src="assets/images/product-cards/1.jpg" alt="">
    ...
    <div class="product-outer" style="height: 216px;">
		<div class="media product-inner">
			...
			<a class="media-left" href="single-product.html" title="Pendrive USB 3.0 Flash 64 GB">
				<img class="media-object wp-post-image img-responsive" src="assets/images/product-cards/4.jpg" alt="">
				...
				<div class="hover-area">
	                <div class="action-buttons">
	                    ...
	                    <a href="#" class="add-to-compare-link">Compare</a>
							...
							</ul></div><div class="owl-item" style="width: 1170px;"><ul class="products columns-2">
														<li class="product product-card first">
				...
				<div class="hover-area">
	                <div class="action-buttons">
	                    ...
	                    <a href="#" class="add-to-compare-link">Compare</a>
							...
							</ul></div></div></div><div class="owl-nav disabled"><div class="owl-prev"></div><div class="owl-next"></div></div><div class="owl-dots"><div class="owl-dot active"><span></span></div><div class="owl-dot"><span></span></div></div></div>
