                            ...
                            <table class="table table-compare compare-list">
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <a class="product" href="single-product.html">
                                                <div class="product-image">
                                                    <div class="">
                                                    <img width="250" height="232" alt="1" class="wp-post-image" src="<?php echo base_url."assets/"; ?>assets/images/products/1.jpg">
                                                </div>
                                                </div>
                                        ...
                                        <td>
                                            <a class="product" href="single-product.html">
                                                <div class="product-image">
                                                    <div class="">
                                                        <img width="250" height="232" alt="Ultrabooks" class="attachment-shop_catalog size-shop_catalog wp-post-image" src="<?php echo base_url."assets/"; ?>assets/images/products/2.jpg">
                                                    </div>
                                                </div>
                                                <div class="product-info">
                                                    <h3 class="product-title">Tablet Red EliteBook  Revolve 810 G2</h3>

                                                    <div title="Rated 3.33 out of 5" class="star-rating"><span style="width:66.6%"><strong class="rating">3.33</strong> out of 5</span></div>
                                                </div>
                                            </a><!-- /.product -->
                                        </td>
                                        <td>
                                            <a class="product" href="single-product.html">
                                                <div class="product-image">
                                                    <div class="">
                                                        <img width="250" height="232" alt="GameStation" class="attachment-shop_catalog size-shop_catalog wp-post-image" src="<?php echo base_url."assets/"; ?>assets/images/products/3.jpg">
                                                    </div>
                                                </div>
                                                <div class="product-info">
                                                    <h3 class="product-title">GameConsole Destiny  Special Edition</h3>
                                                    <div title="Rated 3.67 out of 5" class="star-rating"><span style="width:73.4%"><strong class="rating">3.67</strong> out of 5</span></div>
                                                </div>
                                            </a><!-- /.product -->
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <th>Add to cart</th>
                                        <td>
                                            <a class="button" href="cart.html" rel="nofollow">Add to cart</a>
                                        </td>
                                        <td>
                                            <a class="button" href="cart.html" rel="nofollow">Add to cart</a>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="#" title="Remove" class="remove-icon"><i class="fa fa-times"></i></a>
                                        </td>
                                        <td class="text-center">
                                            <a href="#" title="Remove" class="remove-icon"><i class="fa fa-times"></i></a>
                                        </td>
