...
<div class="top-bar">
    ...
    <nav>
			<ul id="menu-top-bar-right" class="nav nav-inline pull-right animate-dropdown flip">
				...
				<li class="menu-item animate-dropdown"><a title="My Account" href="<?php echo base_url."konten/myaccount/ringkasan_akun.php" ?>"><i class="ec ec-user"></i>My Account</a></li>
				<li class="menu-item animate-dropdown"><a title="My Account" href="<?php echo base_url."konten/mystore/my_store.php"; ?>"><i class="fas fa-store-alt"></i>My Store</a></li>
		...
		<ul class="dropdown-menu dropdown-menu-mini-cart">
			<li>
				<div class="widget_shopping_cart_content">
					...
					<p class="buttons">
						<a class="button wc-forward" href="<?php echo base_url."konten/myaccount/pesanan_saya.php"; ?>">View Cart</a>
						<a class="button checkout wc-forward" href="<?php echo base_url."konten/checkout.php"; ?>">Checkout</a>
					</p>
	...
	<div class="container">
		...
		<div class="collapse navbar-toggleable-xs" id="header-v3">
			<ul class="nav navbar-nav">
				<li class="menu-item
				animate-dropdown"><a title="TV &amp; Audio" href="">E-voucher & Tiket</a></li>
				<li class="menu-item"><a title="RTV" href="">Reksa Dana</a></li>
				<li class="menu-item"><a title="Computers" href="">Mobil & Motor</a></li>
				<li class="menu-item"><a title="Games &amp; Consoles" href="">Mitra Muslim</a></li>
				<li class="menu-item"><a title="Gadgets" href="">Investasi Emas</a></li>
				<li class="menu-item"><a title="Phones &amp; Tablets" href="">Mulai Jualan</a></li>
				<li class="menu-item"><a title="Phones &amp; Tablets" href="<?php echo base_url."konten/promo.php"; ?>">Promo</a></li>
			</ul>
		</div><!-- /.collpase -->
	</div><!-- /.-container -->
</nav><!-- /.navbar -->
