	...
	<div class="container">
		...
		<nav>
			<ul id="menu-top-bar-right" class="nav nav-inline pull-right animate-dropdown flip">
				...
				<li class="menu-item animate-dropdown"><a title="Shop" href="<?php echo base_url."konten/shop.php"; ?>"><i class="ec ec-shopping-bag"></i>Shop</a></li>
				<li class="menu-item animate-dropdown"><a title="My Account" href="<?php echo base_url."konten/myaccount/my_account.php"; ?>"><i class="ec ec-user"></i>My Account</a></li>
				<li class="menu-item animate-dropdown"><a title="My Account" href="<?php echo base_url."konten/mystore/my_store.php"; ?>"><i class="flaticon-shop"></i>My Store</a></li>
				<li class="menu-item animate-dropdown"><a title="My Account" href="<?php echo base_url."konten/transaksi/transaksi.php"; ?>"><i class="flaticon-theft"></i>Transaction</a></li>
			</ul>
		</nav>
	</div>
</div>
...
<nav class="navbar navbar-primary navbar-full">
    ...
    <li class="menu-item animate-dropdown menu-item-object-static_block" style="min-height: 743.004px;">
		...
		<ul class="dropdown-menu dropdown-menu-mini-cart">
			<li>
				<div class="widget_shopping_cart_content">
					...
					<ul class="cart_list product_list_widget ">
						...
						<li class="mini_cart_item">
							...
							<a href="single-product.html">
								<img class="attachment-shop_thumbnail size-shop_thumbnail wp-post-image" src="<?php echo base_url."assets/"; ?>assets/images/products/mini-cart1.jpg" alt="">White lumia 9001&nbsp;
							</a>
						...
						<li class="mini_cart_item">
							<a title="Remove this item" class="remove" href="#">×</a>
							<a href="single-product.html">
								<img class="attachment-shop_thumbnail size-shop_thumbnail wp-post-image" src="<?php echo base_url."assets/"; ?>assets/images/products/mini-cart2.jpg" alt="">PlayStation 4&nbsp;
							</a>
						...
						<li class="mini_cart_item">
							...
							<a href="single-product.html">
							<img class="attachment-shop_thumbnail size-shop_thumbnail wp-post-image" src="<?php echo base_url."assets/"; ?>assets/images/products/mini-cart3.jpg" alt="">POV Action Cam HDR-AS100V&nbsp;
					...
					<p class="buttons">
						<a class="button wc-forward" href="<?php echo base_url."konten/pesanan_saya.php"; ?>">View Cart</a>
...
<ul class="navbar-compare nav navbar-nav pull-right flip">
	<li class="nav-item">
		<a href="<?php echo base_url."konten/compare.php"; ?>" class="nav-link"><i class="ec ec-compare"></i></a>
	</li>
</ul>
